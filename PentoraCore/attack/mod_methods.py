# Module Description:
# This module tests for dangerous HTTP methods that might be enabled on the server.
# It checks for methods like PUT, DELETE, TRACE, and others that could potentially
# be abused if improperly configured. Certain HTTP methods can allow attackers to
# upload malicious files, delete content, or gather information about the server
# if not properly restricted.
from typing import Optional, Set, Dict

from httpx import RequestError

from PentoraCore.main.log import log_verbose, log_orange

from PentoraCore.attack.attack import Attack
from PentoraCore.definitions.methods import MethodsFinding
