# Module Description:
# This module detects file inclusion vulnerabilities (LFI/RFI) by testing parameters
# that might be used to include files from the local filesystem or remote servers.
# These vulnerabilities can lead to source code disclosure, sensitive information
# leakage, or in some cases, remote code execution.
import re
...
from PentoraCore.main.log import log_red, log_orange, log_verbose, logging, log_blue
...
from PentoraCore.definitions.file import PathTraversalFinding
