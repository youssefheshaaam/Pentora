# Module Description:
# This module detects Cross-Site Scripting (XSS) vulnerabilities by injecting
# JavaScript payloads into parameters and analyzing responses. It can identify
# reflected XSS where malicious scripts are immediately returned to the user
# in the response, potentially allowing attackers to steal cookies, session
# tokens, or execute malicious code in the victim's browser.
from os.path import join as path_join
from typing import Optional, Iterator, List, Tuple, Dict

from httpx import ReadTimeout, RequestError

from PentoraCore.main.log import log_orange, log_red, log_verbose
from PentoraCore.attack.attack import Attack, Mutator, ParameterSituation, random_string, Parameter
from PentoraCore.language.vulnerability import Messages
from PentoraCore.definitions.reflected_xss import XssFinding
from PentoraCore.definitions.html_injection import HtmlInjectionFinding
