# Module Description:
# This module detects XML External Entity (XXE) vulnerabilities by testing XML processing
# endpoints. XXE vulnerabilities allow attackers to read local files, perform server-side
# request forgery, or execute denial of service attacks by exploiting how XML parsers
# process external entity references. The module tests various XXE payloads to identify
...
from PentoraCore.main.log import logging, log_blue, log_red, log_orange, log_verbose
from PentoraCore.attack.attack import Attack, XXEUploadMutator, Mutator, Parameter
from PentoraCore.language.vulnerability import Messages
from PentoraCore.definitions.xxe import XxeFinding
