# Module Description:
# This module detects SQL injection vulnerabilities using error-based and 
# boolean-based (blind) techniques. It tests for various database types by
# injecting payloads and analyzing responses for database errors or behavioral
# differences indicating successful SQL injection.
import dataclasses
import re
...
from PentoraCore.attack.attack import Attack, Mutator, Parameter
