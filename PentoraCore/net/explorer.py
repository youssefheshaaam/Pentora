...
# Internal libraries
from PentoraCore.net import web

from PentoraCore.net.response import Response
from PentoraCore.net import Request, make_absolute
from PentoraCore.parsers.html_parser import Html
from PentoraCore.parsers.javascript import extract_js_redirections
from PentoraCore.main.log import logging, log_blue, log_verbose
from PentoraCore.net.classes import CrawlerConfiguration
from PentoraCore.net.crawler import AsyncCrawler
from PentoraCore.parsers import swf
from PentoraCore.net import jsparser_angular
...
class Explorer:
    ...
    async def _async_analyze(self, request) -> Tuple[bool, List, Optional[Response]]:
        async with self._sem:
            ...
            try:
                response: Response = await self._crawler.async_send(request, stream=True, follow_redirects=True)
