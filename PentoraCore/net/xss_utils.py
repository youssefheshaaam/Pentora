...
from PentoraCore.attack.attack import PayloadType, random_string
from PentoraCore.net import Response
...
def generate_payloads(
        html_code: str, code: str, payload_file: str, external_endpoint: str = "http://pentora3.ovh/"
) -> List[PayloadInfo]:
