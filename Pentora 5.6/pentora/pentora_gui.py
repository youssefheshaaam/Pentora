...
try:
    ...
    from PyQt5.QtCore import Qt, QThread, pyqtSignal, QSize, QTimer, QUrl, QObject
    ...
    async def run_scan(self):
        try:
            ...
            try:
                ...
                # Set report format
                report_format = self.options.get('report_format', 'html')
                self.update_status.emit(f"Setting report format to {report_format}...")
                self.pentora.set_report_generator_type(report_format)
                ...
                self.update_status.emit(f"Setting output file to {report_path}.{report_format}...")
                self.pentora.set_output_file(report_path + "." + report_format)
                ...
                # The report has already been generated in the attack method
                self.report_file = self.pentora.output_file
...
class NetworkScannerThread(QThread):
    ...
    def run(self):
        ...
        try:
            ...
            scanner.set_report_format(self.report_format)
