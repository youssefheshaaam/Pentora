...
# Internal libraries
from PentoraCore import parser_name
...
AUTOFILL_VALUES = {
    ...
    "email": "pentora2025@mailinator.com",
    ...
    "text": "default",
    "time": "13:37",
    "url": "https://pentora-scanner.github.io/",
    "username": "alice",
    "week": "2019-W24"
}
            ...
            for i, input_field in enumerate(form.find_all("input")):
                ...
                if input_type == "email":
                    username_field_idx.append(i)
                        ...
                        any(field_name in input_name for field_name in ["mail", "user", "login", "name", "uname"]) or
                        any(field_id in input_id for field_id in ["mail", "user", "login", "name", "uname"])
                ):
                    username_field_idx.append(i)
