...
from PentoraCore.mutation.json_mutator import get_item, set_item, find_injectable
...
class Attack:
    ...
    DATA_DIR = str(files("PentoraCore").joinpath("data", "attacks"))
    ...
    def get_resource(resource_path: str):
        return str(files("PentoraCore").joinpath("data", "attacks", resource_path))
    ...
    def user_config_dir(self):
        """Return the path to the directory where the user's config files are stored"""
        return os.path.join(self.HOME_DIR, ".pentora", "config")
