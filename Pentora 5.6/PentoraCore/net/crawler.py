...
class AsyncCrawler:
    ...
    async def async_request(
        ...
        try:
            ...
            # Handle invalid URLs (like data: URLs) that can't be properly followed
            # Return the original response without following the redirect
            if not follow_redirects:
                raise exception
            # If we're trying to follow redirects but encounter an invalid URL,
            # return the response without following the redirect
